...
$query_rsHardwareAssets = "SELECT * FROM assets_hardware WHERE assets_hardware.asset_type = 'Monitor' LIMIT ?, ?";
...
if (isset($_GET['totalRows_rsHardwareAssets'])) {
  ...
  $query_rsHardwareAssetsCount = "SELECT COUNT(*) as total FROM assets_hardware WHERE assets_hardware.asset_type = 'Monitor'";
